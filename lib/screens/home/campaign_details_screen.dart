          ...
          actions: [
            Padding(
              ...
              child: Container(
                ...
                child: Icon(
                  getDomainIcon(widget.campaignResponse.projectResponse.domain),
                  size: 24,
                  color: Colors.white,
                ),
              ),
              ...
              children: [
                ...
                if (widget.campaignResponse.type == CampaignType.donation)
                  Container(
                    ...
                    child: widget.campaignResponse.rewards.isEmpty
                        ? Center(
                            child: Text(
                              "Aucune récompense pour cette campagne",
                            ),
                          )
                        : ScrollConfiguration(
                            ...
                            child: SingleChildScrollView(
                              child: Row(
                                children: widget.campaignResponse.rewards
                                    .map(
                                      (reward) => Container(
                                        width: 200,
                                        decoration: BoxDecoration(
