...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  final TextEditingController _previousPasswordContoller =
  ...
  bool _areFieldsValidated = false;
  ...
  void _validateFields() {
    setState(() {
      _areFieldsValidated =
          _previousPasswordContoller.text.trim().isNotEmpty &&
          validatePassword(_newPasswordController.text.trim()) &&
        ...
        body: Column(
          ...
          children: [
            ...
            SizedBox(
              width: 300,
              child: Text(
                "Cette action requiert une authentification, confirmez votre ancien mot de passe pour continuer.",
                style: TextStyle(
                  fontSize: 14,
            ...
            CustomTextField(
              ...
              isPassword: false,
              controller: _previousPasswordContoller,
              width: 300,
              onChange: (value) {
                _validateFields();
              },
            ...
            ElevatedButton(
              onPressed: _isLoading || !_areFieldsValidated
                  ? null
                  : () async {
                      try {
                        setState(() {
